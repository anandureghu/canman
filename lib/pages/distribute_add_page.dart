...
class DistributeAddPage extends StatefulWidget {
  const DistributeAddPage({super.key});

  @override
  State<DistributeAddPage> createState() => _DistributeAddPageState();
}

class _DistributeAddPageState extends State<DistributeAddPage> {
  ...
  Future<void> _handleSubmit() async {
    if (_isFormValid()) {
      ...
      try {
        await _firebaseService.addDistribute(
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('Failed to add distributor: $e'),
